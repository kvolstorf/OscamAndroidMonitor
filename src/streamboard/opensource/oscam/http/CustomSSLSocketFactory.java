...
/**
 * This socket factory will create a SSL socket that accepts self signed certificate. It allows to set X509 hostname checking.
 */
public class CustomSSLSocketFactory implements SocketFactory, LayeredSocketFactory {
	...
	public CustomSSLSocketFactory() throws IOException{
		try {
			...
			_sslcontext.init(null, new TrustManager[] { new CustomX509TrustManager(null) }, null);
		} catch (Exception e) {
